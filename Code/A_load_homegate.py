...
def upload_data_to_db():
    ...
    mariadb_connection = mariadb.connect(user="admin_olivier",
                                         password="Pa$$w0rd",
                                         host="10.177.124.137",
                                         port=3306,
                                         database="CIP",
    ...
    mycursor.execute("""LOAD DATA LOCAL INFILE '../Data/stage/A_homegate_newest_stage.csv' 
                            INTO TABLE  homegate_table 
...
def get_data_from_db():
    # Verbinde mit der MariaDB
    engine = create_engine("mariadb://admin_olivier:Pa$$w0rd@10.177.124.137/CIP")

    # Definiere SQL-Query
    query = """SELECT * FROM homegate_table;"""
